 ...
 */
class ContextualHypergraph extends NARHyper {
  constructor(config = {}) {
    super(config);
 ...
 */
class SelfCorrectingNAR extends NARHyper {
  constructor(config = {}) {
    super(config);
    this.errorSystem = {
   ...
   */
  class EnhancedTruthValue extends TruthValue {
 ...
 */
class GoalDirectedNAR extends NARHyper {
  constructor(config = {}) {
    super(config);
 ...
 */
class MultiModalNAR extends NARHyper {
  constructor(config = {}) {
    super(config);
