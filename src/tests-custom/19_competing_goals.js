export default [
    {
        ...
        description:
            'Tests the system ability to choose between multiple competing goals.',
        steps: [
            {
                comment:
                    'Establish two competing goals with different utilities.',
                action: (nar) => {
                ...
                assert: (nar, logs) => {
                    ...
                    const haveCakeGoal = goals.find(
                        (g) => g.description === 'have_cake'
                    );
            ...
            {
                comment:
                    'Introduce an action that achieves the lower-priority goal.',
                action: (nar) => {
                ...
                assert: (nar, logs) => {
                    ...
                    const getForkGoal = goals.find(
                        (g) => g.description === 'get_fork'
                    );
