    ...
    steps: [
        {
            ...
            assert: (nar, logs) => {
                const inferredRelation = nar.temporalManager.inferRelationship(
                    'event_A',
                    'event_C'
                );
        ...
        },
        {
            ...
            assert: (nar, logs) => {
                const paradoxLog = logs.some((l) =>
                    l.includes(
                        'Temporal constraint would create contradiction: event_Y before event_X'
                    )
                );
                return paradoxLog;
            },
