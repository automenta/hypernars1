export default {
    ...
    description:
        'Tests how the system handles uncertain information and revises its beliefs when presented with new evidence.',
    steps: [
        {
        ...
        {
            comment:
                'Introduce new, conflicting evidence with high confidence.',
            action: (nar) => {
            ...
            assert: (nar, logs) => {
                ...
                return (
                    sunnyBelief.truth.expectation() < 0.5 &&
                    rainyBelief.truth.expectation() > 0.8
                );
            },
        },
        {
            ...
            action: (nar) => {
                ...
                nar.nal(
                    '((sky --> clear) ==> (weather --> sunny)). %0.9; 0.9%'
                );
                nar.run(30);
            },
            assert: (nar, logs) => {
