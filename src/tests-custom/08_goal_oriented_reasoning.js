export default {
    ...
    description:
        "[SKIPPED] Tests the system's ability to achieve and abandon goals.",
    ...
    steps: [
        {
            ...
            action: (nar) => {
                ...
                nar.implication(premise1, conclusion1, {
            ...
            assert: (nar, logs) => {
                ...
                const achievedQuery = nar.query('state_B', {
                    minExpectation: 0.7,
                });
                const goalAchievedLog = logs.some((l) =>
                    l.includes('goal-achieved')
                );
                return (
                    achievedQuery && achievedQuery.length > 0 && goalAchievedLog
                );
            },
        },
    ],
