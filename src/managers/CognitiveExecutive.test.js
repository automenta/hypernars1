...
describe('CognitiveExecutive', () => {
    ...
    describe('Initialization', () => {
        ...
        it('should allow overriding default configuration', () => {
            const customConfig = {
                cognitiveExecutive: { MAINTENANCE_INTERVAL: 200 },
            };
            const customNar = {
                ...mockNar,
                config: { ...mockNar.config, ...customConfig },
            };
    ...
    describe('Self-Monitoring and Adaptation', () => {
        it('should calculate system metrics correctly', () => {
            mockNar.derivationEngine.getAndResetInferenceCount.mockReturnValue(
                50
            );
        ...
        it('should adapt reasoning parameters for high contradictions', () => {
            ...
            expect(mockNar.config.inferenceThreshold).toBeGreaterThan(
                initialThreshold
            );
        });
        ...
        it('should adapt reasoning parameters for low inference rate', () => {
            ...
            expect(mockNar.config.inferenceThreshold).toBeLessThan(
                initialThreshold
            );
        });
    });
    ...
    describe('Resource and Focus Management', () => {
        it('should adjust resource allocation based on metrics', () => {
            ...
            expect(executive.resourceAllocation.derivation).toBeGreaterThan(
                initialAllocation
            );
        });
        ...
        it('should normalize resource allocation to sum to 1', () => {
            ...
            executive._adjustResourceAllocation(metrics);
            const total = Object.values(executive.resourceAllocation).reduce(
                (a, b) => a + b,
                0
            );
    ...
    describe('Rule and Strategy Management', () => {
        ...
        it('should adapt rule priorities based on efficiency', () => {
            mockNar.derivationEngine.rules.set('EfficientRule', {
                priority: 0.5,
            });
            mockNar.derivationEngine.rules.set('InefficientRule', {
                priority: 0.5,
            });
            executive.rulePerformance.set('EfficientRule', {
                successes: 9,
                attempts: 10,
                totalCost: 100,
                totalValue: 9,
            ...
            const efficientRule =
                mockNar.derivationEngine.rules.get('EfficientRule');
            const inefficientRule =
                mockNar.derivationEngine.rules.get('InefficientRule');
        ...
        it('should return the active strategy based on context', () => {
            ...
            jest.spyOn(executive, '_assessReasoningContext').mockReturnValue([
                'high-uncertainty',
            ]);
    ...
    describe('Knowledge Pruning', () => {
        it('should prune low-value knowledge', () => {
            ...
            expect(mockNar.api.removeHyperedge).toHaveBeenCalledWith(
                'oldAndWeak'
            );
            expect(mockNar.api.removeHyperedge).not.toHaveBeenCalledWith(
                'recentButWeak'
            );
            expect(mockNar.api.removeHyperedge).not.toHaveBeenCalledWith(
                'oldButStrong'
