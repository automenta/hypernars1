export default {
    ...
    description: 'Tests the system\'s ability to reason by analogy, mapping relationships from a source domain to a target domain.',
    steps: [
        {
        ...
        {
            comment: 'Assert the analogy: check if the property from the source domain is inferred in the target domain.',
            action: (nar) => {
            ...
            assert: (nar, logs) => {
                ...
                const analogyId = nar.inheritance('nucleus', 'gravitational_center');
